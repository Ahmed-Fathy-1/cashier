    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        ...
        <div class="col-span-12 grid lg:col-span-12">
            <h4 class="card">
                ...
                <form action="{{ route('main_needs.update', 1) }}" method="POST" enctype="multipart/form-data" id="identifier">
                    @csrf
                    @method('PUT')
                        ...
                        <label class="block">
                            ...
                            <label class="block">
                                ...
                                <input name="title"
                                       ...
                                       placeholder="Enter Title" type="text" value="{{  $mainNeed->title }}">
                            </label>
                            @error('title')
                            ...
                            <textarea id="descTwo" name="desc" style="display: none;">{{  $mainNeed->desc }}</textarea>
                            ...
                            <div>
                                <img id="imagePreview1" src="{{ asset('storage/uploads/images/needs/'.$mainNeed->image) }}" alt="Current Image"
...
@push('scripts')
    ...
    <script>
        ...
        const descTwo = {!! json_encode($mainNeed->desc) !!};
