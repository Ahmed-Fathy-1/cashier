                        ...
                        <label class="block">
                            ...
                            <label class="block">
                                ...
                                <input name="title"
                                       ...
                                       placeholder="Enter Title" type="text" value="{{  $subNeeds->title }}">
                            </label>
                            @error('title')
                            ...
                            <textarea id="descTwo" name="desc" style="display: none;">{{  $subNeeds->desc }}</textarea>
                            ...
                            <div>
                                <img id="imagePreview1" src="{{ asset('storage/uploads/images/needs/'.$subNeeds->image) }}" alt="Current Image"
...
@push('scripts')
    ...
    <script>
        ...
        const descTwo = {!! json_encode($subNeeds->desc) !!};
