...
@section('main')
    ...
    <main class="main-content w-full  px-[var(--margin-x)] pb-12">
        <div class="flex items-center space-x-4 py-5 lg:py-6">
            <h2 class="text-xl font-medium text-slate-800 dark:text-navy-50 lg:text-2xl">
                AiTech
            </h2>
        ...
        {{-- <div class="max-w-4xl grid-cols-1 sm:grid-cols-3 sm:gap-5 lg:gap-6">
        ...
        <div class="grid max-w-4xl grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-5 lg:gap-6">
            ...
            <div class="card p-4 text-center sm:p-5">
                ...
                <div class="mt-5">
                    <span
                        class="text-4xl tracking-tight text-primary dark:text-accent-light">${{ $packages->price }}</span>/month
                ...
                <div class="mt-8 space-y-4 text-left">
                    <div class="flex items-start space-x-3">
                        ...
                        <span class="font-medium">Monthly Price: ${{ $packages->packageDetails->Price_monthly }}</span>
                    </div>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <span class="font-medium">Annual Price: ${{ $packages->packageDetails->Price_annually }}</span>
                    </div>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <span class="font-medium">Monthly Storage: {{ $packages->packageDetails->storage_monthly }}
                            GB</span>
                    </div>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <span class="font-medium">Annual Storage: {{ $packages->packageDetails->storage_annually }}
                            GB</span>
                    </div>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <span class="font-medium">Interactive Archives:
                            {{ $packages->packageDetails->interactive_archives }}</span>
                    </div>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <span class="font-medium">Custom Branding: {{ $packages->packageDetails->custom_branding }}</span>
                    </div>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <span class="font-medium">Messages: {{ $packages->packageDetails->messages }}</span>
                    </div>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <span class="font-medium">Number of Users: {{ $packages->packageDetails->num_users }}</span>
                    </div>
